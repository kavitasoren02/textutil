...
<nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
    <div className='container-fluid'>
        ...
        <div className="collapse navbar-collapse" href="/" id="navbarSupportedContent">
        ...
        <div className="d-flex">
            <div className="bg-primary rounded mx-2" onClick={()=>{props.togglemode('primary')}} style={{height:'25px',width:'25px'}}></div>
            ...
            <div className="bg-warning rounded mx-2" onClick={()=>{props.togglemode('warning')}} style={{height:'25px',width:'25px'}}></div>
        </div>
